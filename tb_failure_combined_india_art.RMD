...
# path to save
path <- file.path("outs", "tbsigprofiler_outs", "baseline")
...
ggsave(file.path(path,"ssGSEA/tbsigprofiler_selectsigs_boxplots.svg"), width = 9, height=12)
```
...
df <- tableAUC(ssgsea_res_select.bl,
         ...
         pb.show = FALSE,
         output = "data.frame")
write.csv(df, file.path(path, "ssGSEA/tbsigprofiler_selectsigs_AUC_boxplots_table_bl.csv"))
...
write.csv(df, file.path(path, "ssGSEA/tbsigprofiler_selectsigs_AUC_boxplots_table_m2.csv"))
...
compareBoxplots(ssgsea_res_select.bl, annotationColName = "subjtype",
                ...
                rotateLabels = TRUE)
ggsave(file.path(path,"ssGSEA/tbsigprofiler_selectsigs_AUC_boxplots_bl.svg"), width = 7, height=7)
```

##### M2
```{r}
path.m2 <- file.path("outs/month_2")
set.seed(0)
