...
plot(g)
ggsave("outs/dimension_reduction/tb_fail_umap_log_counts_pre-batch-corrected.png", width=7, height=7)
ggsave("outs/dimension_reduction/tb_fail_umap_log_counts_pre-batch-corrected.svg", width=7, height=7)
...
ggsave("outs/dimension_reduction/tb_fail_umap_log_cpm_post-batch-corrected.png", width=7, height=7)
ggsave("outs/dimension_reduction/tb_fail_umap_log_cpm_post-batch-corrected.svg", width=7, height=7)
```
...
plot(g)
ggsave("outs/dimension_reduction/tb_fail_umap_log_cpm_post-batch-corrected_combined_duplicates.svg", width=7, height=7)
```
